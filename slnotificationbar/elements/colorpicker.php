...
class JFormFieldColorpicker extends JFormField
{
	...
	protected function getInput()
	{
		...
		$module = str_replace( JPATH_SITE.DS.'plugins'.DS,'',dirname(__FILE__) );
       // $module = substr( $module, 0, strpos($module, DS) );
        ...
        $scriptname	 = $this->element['scriptpath'] ?(string) $this->element['scriptpath'] : $baseurl.'plugins/'.$module.'/../js/colorpicker.js';
